...
function birthdateSort() {
    return (
        <div> 
            ...
            <h2 class="sort-name">January 15, 1929</h2>
            <div>
                <h3 class="author-name">King</h3>
                <div>
                    <div class="quote">
            ...
            <h2 class="sort-name">January 17, 1706</h2>
            <div>
                <h3 class="author-name">Franklin</h3>
                <div>
                    <div class="quote">
            ...
            <h2 class="sort-name">January 29, 1954</h2>
            <div>
                <h3 class="author-name">Winfrey</h3>
                <div>
                    <div class="quote">
            ...
            <h2 class="sort-name">February 6, 1951</h2>
            <div>
                <h3 class="author-name">Rasband</h3>
                <div>
                    <div class="quote">
            ...
            <h2 class="sort-name">March 2, 1904</h2>
            <div>
                <h3 class="author-name">Seuss</h3>
                <div>
                    <div class="quote">
            ...
            <h2 class="sort-name">March 26, 1874</h2>
            <div>
                <h3 class="author-name">Frost</h3>
                <div>
                    <div class="quote">
            ...
            <h2 class="sort-name">April 4, 1928</h2>
            <div>
                <h3 class="author-name">Angelou</h3>
                <div>
                    <div class="quote">
            ...
            <h2 class="sort-name">July 18, 1961</h2>
            <div>
                <h3 class="author-name">Kearon</h3>
                <div>
                    <div class="quote">
            ...
            <h2 class="sort-name">August 6, 1955</h2>
            <div>
                <h3 class="author-name">Stevenson</h3>
                <div>
                    <div class="quote">
            ...
            <h2 class="sort-name">August 12, 1932</h2>
            <div>
                <h3 class="author-name">Oaks</h3>
                <div>
                    <div class="quote">
            ...
            <h2 class="sort-name">August 17, 1893</h2>
            <div>
                <h3 class="author-name">West</h3>
                <div>
                    <div class="quote">
            ...
            <h2 class="sort-name">August 19, 1870</h2>
            <div>
                <h3 class="author-name">Baruch</h3>
                <div>
                    <div class="quote">
            ...
            <h2 class="sort-name">August 22, 1929</h2>
            <div>
                <h3 class="author-name">Purkey</h3>
                <div>
                    <div class="quote">
            ...
            <h2 class="sort-name">September 9, 1924</h2>
            <div>
                <h3 class="author-name">Nelson</h3>
                <div>
                    <div class="quote">
            ...
            <h2 class="sort-name">October 16, 1854</h2>
            <div>
                <h3 class="author-name">Wilde</h3>
                <div>
                    <div class="quote">
            ...
            <h2 class="sort-name">October 17, 1972</h2>
            <div>
                <h3 class="author-name">Eminem</h3>
                <div>
                    <div class="quote">
            ...
            <h2 class="sort-name">November 13, 1952</h2>
            <div>
                <h3 class="author-name">Renlund</h3>
                <div>
                    <div class="quote">
            ...
            <h2 class="sort-name">November 30, 1835</h2>
            <div>
                <h3 class="author-name">Twain</h3>
                <div>
                    <div class="quote">
            ...
            <h2 class="sort-name">December 5, 1901</h2>
            <div>
                <h3 class="author-name">Disney</h3>
                <div>
                    <div class="quote">
